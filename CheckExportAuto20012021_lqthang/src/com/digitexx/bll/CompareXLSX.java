...
public class CompareXLSX {
	public Map<String, List<Boolean>>   getMapResultBatch(Map<String, LinkedList<String>> MapMongoDB,Map<String, Map<String, LinkedList<String>>> mapDataXlSX, String rule, String pathFunction){
		...
		try {
			...
			List<Boolean> listResult = new LinkedList<>();
				...
				Object[] arrDataMongo = MapMongoDB.values().toArray();
				Set<String> paths = mapDataXlSX.keySet();
				for (String path : paths) {
//					Map<String, LinkedList<String>> mapValue = mapDataCSV.get(key);
					Map<String, LinkedList<String>> map = mapDataXlSX.get(path);
					
					
						Object[] arrData = map.values().toArray();
